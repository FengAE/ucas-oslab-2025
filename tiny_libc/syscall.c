...
int sys_mkfs(void)
{
    return invoke_syscall(SYSCALL_FS_MKFS,
                          IGNORE, IGNORE, IGNORE, IGNORE, IGNORE);
}

int sys_statfs(void)
{
    return invoke_syscall(SYSCALL_FS_STATFS,
                          IGNORE, IGNORE, IGNORE, IGNORE, IGNORE);
}

int sys_cd(char *path)
{
    return invoke_syscall(SYSCALL_FS_CD,
                          (long)path, IGNORE, IGNORE, IGNORE, IGNORE);
}

int sys_mkdir(char *path)
{
    return invoke_syscall(SYSCALL_FS_MKDIR,
                          (long)path, IGNORE, IGNORE, IGNORE, IGNORE);
}

int sys_rmdir(char *path)
{
    return invoke_syscall(SYSCALL_FS_RMDIR,
                          (long)path, IGNORE, IGNORE, IGNORE, IGNORE);
}

int sys_ls(char *path, int option)
{
    return invoke_syscall(SYSCALL_FS_LS,
                          (long)path, option, IGNORE, IGNORE, IGNORE);
}

int sys_open(char *path, int mode)
{
    return invoke_syscall(SYSCALL_FS_OPEN,
                          (long)path, mode, IGNORE, IGNORE, IGNORE);
}

int sys_read(int fd, char *buff, int length)
{
    return invoke_syscall(SYSCALL_FS_READ,
                          fd, (long)buff, length, IGNORE, IGNORE);
}

int sys_write(int fd, char *buff, int length)
{
    return invoke_syscall(SYSCALL_FS_WRITE,
                          fd, (long)buff, length, IGNORE, IGNORE);
}

int sys_close(int fd)
{
    return invoke_syscall(SYSCALL_FS_CLOSE,
                          fd, IGNORE, IGNORE, IGNORE, IGNORE);
}

int sys_ln(char *src_path, char *dst_path)
{
    return invoke_syscall(SYSCALL_FS_LN,
                          (long)src_path, (long)dst_path,
                          IGNORE, IGNORE, IGNORE);
}

int sys_rm(char *path)
{
    return invoke_syscall(SYSCALL_FS_RM,
                          (long)path, IGNORE, IGNORE, IGNORE, IGNORE);
}

int sys_lseek(int fd, int offset, int whence)
{
    return invoke_syscall(SYSCALL_FS_LSEEK,
                          fd, offset, whence, IGNORE, IGNORE);
}
...
{
    return invoke_syscall(SYSCALL_NET_RECV_STREAM, (long)buffer, nbytes, IGNORE, IGNORE, IGNORE);
}